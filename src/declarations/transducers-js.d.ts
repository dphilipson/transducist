declare module "transducers-js" {
    ...
    export class Map<TResult, TInput, TOutput>
        ...
        public ["@@transducer/step"](result: TResult, input: TInput): TResult;
    ...
    export class Filter<TResult, TInput>
        implements Transformer<TResult, TInput> {
        constructor(
    ...
    export class TakeNth<TResult, TInput>
        implements Transformer<TResult, TInput> {
        constructor(n: number, xf: Transformer<TResult, TInput>);
        public ["@@transducer/init"](): TResult;
        public ["@@transducer/step"](result: TResult, input: TInput): TResult;
     ...
     * arrays of size N.
     */
    export function partitionAll<TInput>(
        n: number,
    ): Transducer<TInput, TInput[]>;
